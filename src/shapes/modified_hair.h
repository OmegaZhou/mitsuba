...
#if !defined(__MODIFIED_HAIR_H)
#define __MODIFIED_HAIR_H

#include <mitsuba/render/shape.h>

MTS_NAMESPACE_BEGIN

class ModifiedHairKDTree;
 ...
 */
class ModifiedHairShape : public Shape {
public:
    /// Construct a new ModifiedHairShape instance given a properties object
    ModifiedHairShape(const Properties& props);

    /// Unserialize from a binary data stream
    ModifiedHairShape(Stream* stream, InstanceManager* manager);
    ...
    MTS_DECLARE_CLASS()
private:
    ref<ModifiedHairKDTree> m_kdtree;
    Float m_interpolation_thredhold;
